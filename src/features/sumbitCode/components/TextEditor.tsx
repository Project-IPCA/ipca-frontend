...
function BlockOptionsDropdownList({
  ...
  return (
    <List
      className="absolute  flex flex-col gap-0.5 rounded-lg border border-blue-gray-50 bg-white p-1"
      ref={dropDownRef}
    >
      <ListItem
...
function FloatingLinkEditor({ editor }: { editor: LexicalEditor }) {
  ...
  return (
    <div
      ref={editorRef}
      className="absolute -left-[10000px] -top-[10000px]  -mt-1.5 w-full max-w-xs rounded-lg border border-gray-300 bg-white opacity-0 transition-opacity duration-500"
    >
      {isEditMode ? (
        <Input
          crossOrigin=""
